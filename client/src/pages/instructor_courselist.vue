...
<div class="flex justify-between items-center">
    ...
    <Button class="flex gap-2" @click="go('/coursemanage')">
    ...
    >
        ...
        <div class="p-4 space-y-2">
            ...
            <div class="flex gap-2 flex-wrap">
                <Button size="small" @click="go(`/coursemanage?courseId=${course.id}`)">
                    Edit
                </Button>
                <Button size="small" variant="primary_border" @click="go(`/chapterlist?courseId=${course.id}`)">
                    Lessons
                </Button>
                <Button size="small" variant="primary_border" @click="go(`/examlist?courseId=${course.id}`)">
                    Exams
                </Button>
